<template>
  ...
  <script>
  export default {
    name: "TermsAndConditionsManager",
    data() {
      return {
        isEditing: false,
        message: '',
        documents: [
          { id: 1, title: "Términos y Condiciones", content: "Contenido de los términos", version: "1.0", createdAt: "2024-10-01", validUntil: "2025-01-01", deleted: false },
          { id: 2, title: "Términos y Condiciones", content: "Actualización de los términos", version: "1.1", createdAt: "2024-10-10", validUntil: "2025-01-01", deleted: false }
        ],
        document: {
          title: "",
          content: "",

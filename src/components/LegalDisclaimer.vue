<template>
    <div class="container">
      ...
      <form @submit.prevent="handleSubmit" class="shadow p-4 rounded bg-light">
        ...
        <div class="form-group mb-3">
          <label for="content">Contenido del Deslinde Legal</label>
  ...
  <script>
  export default {
    name: "LegalDisclaimerManager",
    data() {
      return {
        isEditing: false,
        message: '',
        documents: [
          { id: 1, title: "Deslinde Legal", content: "Contenido del deslinde", version: "1.0", createdAt: "2024-10-01", validUntil: "2025-01-01", deleted: false },
          { id: 2, title: "Deslinde Legal", content: "Actualización del deslinde", version: "1.1", createdAt: "2024-10-10", validUntil: "2025-01-01", deleted: false }
        ],
        document: {
          title: "",
          content: "",
